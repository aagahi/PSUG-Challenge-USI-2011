...
object QuestionVO {
  def apply( q:Question, score:Int ):QuestionVO = QuestionVO( q.question, q.answers(0).anwser, q.answers(1).anwser, q.answers(2).anwser, q.answers(3).anwser, score )
}
case class QuestionVO( question:String, answer_1:String, answer_2:String, answer_3:String, answer_4:String, score:Int )
