...
object Game{
  def apply( xmlParameters:String ) = {
    ...
    new Game( 0,
              ...
              numPlayer = (xml \ "parameters" \ "nbusersthreshold").text.toInt
    )
  }
}
case class Game( id : Int=0, questions:Seq[Question], loginTimeoutSec:Int=0, synchroTimeSec:Int=0, questionTimeFrameSec:Int=0, nbQuestions:Int=0, flushUserTable:Boolean=false, numPlayer:Int=0 ) extends Data[Int]{
  def storeKey:Int = id
  def copyWithAutoGeneratedId( id:Int ) = Game( id, questions, loginTimeoutSec, synchroTimeSec, questionTimeFrameSec, nbQuestions, flushUserTable, numPlayer )
}
