...
case class User( id:Int, firstName:String, lastName:String, email:String, password:String ) extends Data[Int] with Ordered[User] {
  def storeKey:Int = id
  ...
  def compare(that: User) ={
    ...
    if( c1 == 0 ){
      ...
      if( c2 == 0 ) {
        val c3 = that.email compare email
